...
encodeTrain90d = train90d.apply(labelencoder.fit_transform)
encodeTest10den = test10d.apply(labelencoder.fit_transform)
...
Y_data90d = encodeTrain90d['type'].values # y terain
X_data90d = encodeTrain90d[list(columns)].values # x train
X_test10d = encodeTest10d[list(columns)].values # x test
...
encodeTrain80d = train80d.apply(labelencoder.fit_transform)
encodeTest20den = test20d.apply(labelencoder.fit_transform)
...
encodeTrain70d = train70d.apply(labelencoder.fit_transform)
encodeTest30den = test30d.apply(labelencoder.fit_transform)
...
encodeTrain60d = train60d.apply(labelencoder.fit_transform)
encodeTest40den = test40d.apply(labelencoder.fit_transform)
...
encodeTrain50d = train50d.apply(labelencoder.fit_transform)
encodeTest50den = test50d.apply(labelencoder.fit_transform)
